	...
	<div class="search_wrap">
		...
		<div class="search_group">
			<form name="myform" method="get" action="notice.do">
				...
				<input type="text" name="keyword" class="search_word" placeholder="검색 단어 입력...">
		...
		<table class="bord_table" summary="이표는 번호,제목,글쓴이,날자,조회수로 구성되어 있습니다">
			...
			<tbody>
				...
				<c:forEach var="notice" items="${noticelist}">
					<tr>
						<td>${num}</td>
						<td class="title"><a href="noticeview.do?bno=${notice.bno}&p=${pagemaker.cri.pageNum}&a=${pagemaker.cri.amount}">${notice.title}</a></td>
						<td>${notice.writer}</td>
