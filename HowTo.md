...
- [메인 페이지](/README.md)에 있는 달력의 날짜를 클릭하면 그 날 사용했던 소스 코드 폴더로 바로 이동합니다.
    - 예컨대 [2022년 10월 26일에 배웠던 내용](/221011-_JAVA_AND_ETC/221026/)을 보고 싶다면

        | → | 24 | 25 | [26](/221011-_JAVA_AND_ETC/221026/) | | |
        |---|---|---|---|---|---|
        |||| ... |||
        | 10 ||| ... |||
        || 월 | 화 | 수 | 목 | 금 |
...
- 메인 페이지로 돌아가고 싶다면 맨 위의 [JSL56-lectures](/README.md)링크를 클릭하시면 됩니다.
