...
<!-- sub contents -->
	...
	<div class="container">
		<div class="board_view">
			...
			<div class="prev_next">
				<a href="?bno=${prev.bno}" class="btn_prev">
				...
				<div class="btn_3wrap">
					...
					<a href="notice_modify.do">수정</a>
					<a href="notice_delete.do" onClick="return confirm('삭제하시겠어요?')">삭제</a>
				</div>
				<a href="?bno=${next.bno}" class="btn_next">
